...
const T_KERNEL_TCB_ROM kernel_tcb_rom[3] =
	{
		...
		{(ATR)(TA_HLNG), (VP_INT)(1), (FP)(checkButton), (PRI)(4), (SIZE)(256), (VP)kernel_tsk2_stk},
		{(ATR)(TA_HLNG), (VP_INT)(1), (FP)(buttonHandler), (PRI)(4), (SIZE)(256), (VP)kernel_tsk3_stk},
	};
...
T_KERNEL_FLGCB_RAM *kernel_flgcb_ram_tbl[4] =
	{
		NULL,
		NULL,
		NULL,
...
T_KERNEL_CYCCB_RAM *kernel_cyccb_ram_tbl[8] =
	{
		NULL,
		NULL,
		NULL,
